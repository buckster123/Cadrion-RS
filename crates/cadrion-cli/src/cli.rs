...
#[command(
    name = "cadrion",
    version,
    about = "Cadrion — Rust-native CAD runtime for AI agents",
    long_about = None
)]
pub struct Cli {
    ...
    #[arg(long, global = true, env = "CADRION_PROJECT")]
    pub project: Option<PathBuf>,

    /// Geometry kernel: mock (default) | occt | truck (seed) | truck-brep (H3-6 spike).
    #[arg(long, global = true, env = "CADRION_KERNEL", default_value = "mock")]
    pub kernel: KernelId,
...
pub enum Commands {
    ...
    Printer(PrinterArgs),
    /// Clean-room build123d-style Python → Cadrion `.cad.star` skeleton (best-effort).
    Migrate(MigrateArgs),
...
pub struct ViewArgs {
    ...
    #[arg(long, default_value_t = 7411, env = "CADRION_VIEWER_PORT")]
    pub port: u16,
...
#[derive(Debug, Subcommand)]
pub enum SkillsCmd {
    /// Export bundled Cadrion skill pack to a directory.
    Export(SkillsExportArgs),
}

#[derive(Debug, clap::Args)]
pub struct SkillsExportArgs {
    /// Output directory (default: dist/skills/cadrion, or dist/skills with --all).
    #[arg(long, short = 'o')]
    pub out: Option<PathBuf>,
    ...
    /// Export packs for claude-code, codex, and hermes under `<out>/<agent>/cadrion`.
    #[arg(long)]
    pub all: bool,
}
...
pub struct ServeApiArgs {
    #[arg(long, default_value = "127.0.0.1")]
    pub host: String,
    #[arg(long, default_value_t = 7410, env = "CADRION_API_PORT")]
    pub port: u16,
    /// Optional bearer token (also `CADRION_API_TOKEN`).
    #[arg(long, env = "CADRION_API_TOKEN")]
...
pub struct ServeMcpArgs {
    #[arg(long, default_value = "127.0.0.1")]
    pub host: String,
    #[arg(long, default_value_t = 7420, env = "CADRION_MCP_PORT")]
    pub port: u16,
    /// Optional bearer token (also `CADRION_MCP_TOKEN`).
    #[arg(long, env = "CADRION_MCP_TOKEN")]
    pub token: Option<String>,
}
...
pub struct PrinterStatusArgs {
    ...
    pub model: String,
    #[arg(long, env = "CADRION_BAMBU_SERIAL")]
    pub serial: Option<String>,
    /// Moonraker base URL (default: http://HOST:7125). Env: CADRION_MOONRAKER_URL.
    #[arg(long, env = "CADRION_MOONRAKER_URL")]
    pub moonraker_url: Option<String>,
    /// Moonraker API key. Env: CADRION_MOONRAKER_API_KEY.
    #[arg(long, env = "CADRION_MOONRAKER_API_KEY")]
...
pub struct PrinterDryRunArgs {
    ...
    #[arg(long, env = "CADRION_BAMBU_SERIAL")]
    pub serial: Option<String>,
    #[arg(long, env = "CADRION_BAMBU_ACCESS_CODE")]
...
pub struct PrinterStartArgs {
    ...
    #[arg(long, default_value_t = false)]
    pub live: bool,
    /// Printer serial (MQTT topic, Bambu). Env: CADRION_BAMBU_SERIAL.
    #[arg(long, env = "CADRION_BAMBU_SERIAL")]
    pub serial: Option<String>,
    /// LAN access code (Bambu). Env: CADRION_BAMBU_ACCESS_CODE.
    #[arg(long, env = "CADRION_BAMBU_ACCESS_CODE")]
    pub access_code: Option<String>,
    /// Moonraker base URL. Env: CADRION_MOONRAKER_URL.
    #[arg(long, env = "CADRION_MOONRAKER_URL")]
    pub moonraker_url: Option<String>,
    /// Moonraker API key. Env: CADRION_MOONRAKER_API_KEY.
    #[arg(long, env = "CADRION_MOONRAKER_API_KEY")]
