...
pub enum KernelBox {
    Mock(MockKernel),
    #[cfg(feature = "occt")]
    Occt(cadrion_occt::OcctKernel),
    Truck(cadrion_truck::TruckKernel),
    #[cfg(feature = "truck-brep")]
    TruckBrep(cadrion_truck::TruckBrepKernel),
}
...
pub fn open_kernel(id: KernelId) -> Result<KernelBox, (ExitCode, serde_json::Value)> {
    match id {
        ...
        KernelId::Truck => Ok(KernelBox::Truck(cadrion_truck::TruckKernel::new())),
        KernelId::TruckBrep => {
            #[cfg(feature = "truck-brep")]
            {
                Ok(KernelBox::TruckBrep(cadrion_truck::TruckBrepKernel::new()))
            }
                ...
                Err((
                    ...
                    serde_json::json!({
                        ...
                        "diagnostics": [{
                            ...
                            "hint": "rebuild with: cargo build -p cadrion-cli --features truck-brep"
                        }]
                    }),
                ))
            }
        ...
        KernelId::Occt => {
            #[cfg(feature = "occt")]
            {
                Ok(KernelBox::Occt(cadrion_occt::OcctKernel::new()))
            }
