...
**Status:** **active** board (chartered 2026-08-20 after Horizon-4 cook list complete)  
...
**Default next if “cook on” with no pref:** **H5-1** (fair prompts — cheapest honesty win).

---

## 7. Checklist

- [ ] **H5-1** Harness prompt honesty  
