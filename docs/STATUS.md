...
**As of:** 2026-08-21 · **tip:** H6-3 gcode_check · **version:** 0.1.0  
...
## Next board
**Active:** Horizon-6 — default next **H6-4** (fab_slice).  
...
- Tools: 20 — see [`HERMES_MCP.md`](HERMES_MCP.md) (H6-3 added gcode_check)
